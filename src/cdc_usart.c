...
static void CDCUSARTInitialize() {
...
static void CDCUSARTDMARXInitialize(uint8_t* memoryBaseAddr, uint16_t bufferSize) {
...
static void CDCUSARTDMATXInitialize(uint8_t* memoryBaseAddr, uint16_t bufferSize) {
	DMA_InitTypeDef DMA_InitStructure;
